  ...
  return (
    <div className={styles.resume}>
      ...
      <div className={styles.left}>
        ...
        <Section secId="3" secTitleName="Programming Languages" itemData1="Programming Language" itemData2={7} itemData3="" data={progLangs} className="progLangs"/>
      ...
      <div className={styles.right}>
        ...
        <Section secId="6" secTitleName="Projects" itemData1="Project Name" itemData2="TechStack Used" itemData3="" data={projects} className="projects"/>

        <Section secId="7" secTitleName="Languages" itemData1="Language" itemData2={4} itemData3="" data={langs} className="langs"/>
